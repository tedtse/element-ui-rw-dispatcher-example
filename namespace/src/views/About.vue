  ...
  <div class="elm-container">
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <div style="text-align: right">
        <el-button v-show="myNsState === 'write'" type="primary" size="small" @click="toggleState">编辑</el-button>
        <el-button v-show="myNsState === 'read'" type="primary" size="small" @click="toggleState">详情</el-button>
      </div>
    </el-form>
  </div>
</template>
